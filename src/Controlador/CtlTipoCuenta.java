...
public class CtlTipoCuenta {
    ...
    public DefaultTableModel listartipocuentaCosto(JTable table, int id) {
        DefaultTableModel model = (DefaultTableModel) table.getModel();
        model.setRowCount(0);
        ArrayList<TipoCuentaCosto> tipos = dao.listar(id);
        for (TipoCuentaCosto tipo : tipos) {
