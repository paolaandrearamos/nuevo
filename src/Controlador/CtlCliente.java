...
public class CtlCliente {
    public static String tabla = "Persona2";
    ...
    public boolean guardar(ClsCliente cliente) {
     ...
     public boolean SolicitudModificar(int cedula, int telefono, String nombre, String fecha_nacimiento,String apellido, String ciudad, String correo, int idSucursal) {
        ClsCliente usuario = new ClsCliente(cedula, telefono, nombre, apellido,fecha_nacimiento, ciudad, correo,idSucursal);
